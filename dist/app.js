...
function textToNumeric(text, X, z) {
    const blocks = [];
...
const encryptionN = document.getElementById("encryption-n");
const encryptionE = document.getElementById("encryption-e");
const decryptionN = document.getElementById("decryption-n");
const decryptionD = document.getElementById("decryption-d");
const toggleMode = document.getElementById("encrypt-decrypt-toggle");
